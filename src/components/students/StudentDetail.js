...
const StudentDetail = () => {
  ...
  return (
    <Box sx={{ p: { xs: 2, sm: 3 } }}>
          ...
          <Grid container spacing={{ xs: 2, sm: 3, md: 4 }}>
                    ...
                    <Box>
                      ...
                      <Chip 
                        ...
                        color={
                          ...
                          student.grade.startsWith('C') ? 'warning' : 'error'
                        }
                        sx={{ mt: 0.5 }}
                      />
                    </Box>
            ...
            <Grid item xs={12} md={6}>
              <Card sx={{ height: '100%', borderRadius: 2, boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}>
                <CardContent sx={{ p: { xs: 2, sm: 3 } }}>
                  <Typography variant="h6" component="h2" gutterBottom sx={{ display: 'flex', alignItems: 'center' }}>
                    <Grade sx={{ mr: 1 }} /> Performance Summary
                  </Typography>
                  <Divider sx={{ my: 2 }} />
                  
                  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                    <Box>
                      <Typography variant="subtitle2" color="text.secondary">Overall Grade</Typography>
                      <Chip 
                        icon={<Grade />} 
                        label={student.grade} 
      ...
      {student.performance && <StudentPerformance student={student} />}
